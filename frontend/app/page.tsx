            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 space-y-4">
                ...
                <div className="pt-4 flex items-center gap-4">
                  ...
                  <Link href="/mfa" className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-700 text-[14px] font-medium px-6 py-3 rounded-xl shadow-sm border border-gray-200 transition-colors">
                    <Shield className="w-4 h-4 text-[#2a2468]" /> Security Settings
                  </Link>
                </div>
              </div>
