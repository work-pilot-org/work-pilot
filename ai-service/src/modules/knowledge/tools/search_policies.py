"""
Policy search tool for the Knowledge Agent.

This tool provides the Knowledge Agent with access to
policy-related information stored in the tenant's
knowledge base.
"""

from __future__ import annotations

from modules.knowledge.exceptions import KnowledgeRetrievalError
...
async def search_policies(
    ...
    *,
    ...
    """
    Search the organization's knowledge base for
    policy-related information.

    Args:
        query:
            Natural-language policy question or search query.
